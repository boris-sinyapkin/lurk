pub mod socks5 {
    ...
    use crate::proto::socks5::consts::SOCKS5_VERSION;
    ...
    impl HandshakeRequest {
        pub async fn parse_from<T: AsyncReadExt + Unpin>(stream: &mut T) -> Result<HandshakeRequest> {
            ...
            expect_field_or_fail!(version, SOCKS5_VERSION);
    ...
    impl RelayRequest {
        pub async fn parse_from<T: AsyncReadExt + Unpin>(stream: &mut T) -> Result<RelayRequest> {
